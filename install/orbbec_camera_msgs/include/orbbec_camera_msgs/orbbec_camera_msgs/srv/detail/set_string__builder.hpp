...
{
public:
  explicit Init_SetString_Event_response(::orbbec_camera_msgs::srv::SetString_Event & msg)
  : msg_(msg)
  {}
  ::orbbec_camera_msgs::srv::SetString_Event response(::orbbec_camera_msgs::srv::SetString_Event::_response_type arg)
  {
...
private:
  ::orbbec_camera_msgs::srv::SetString_Event msg_;
};

class Init_SetString_Event_request
{
public:
  explicit Init_SetString_Event_request(::orbbec_camera_msgs::srv::SetString_Event & msg)
  : msg_(msg)
  {}
  Init_SetString_Event_response request(::orbbec_camera_msgs::srv::SetString_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetString_Event_request info(::orbbec_camera_msgs::srv::SetString_Event::_info_type arg)
  {
...
template<>
inline
auto build<::orbbec_camera_msgs::srv::SetString_Event>()
{
  return orbbec_camera_msgs::srv::builder::Init_SetString_Event_info();
}
