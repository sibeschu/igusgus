...
enum
{
  orbbec_camera_msgs__srv__GetBool_Event__request__MAX_SIZE = 1
};
// response
enum
{
  orbbec_camera_msgs__srv__GetBool_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetBool in the package orbbec_camera_msgs.
typedef struct orbbec_camera_msgs__srv__GetBool_Event
{
  service_msgs__msg__ServiceEventInfo info;
  orbbec_camera_msgs__srv__GetBool_Request__Sequence request;
  orbbec_camera_msgs__srv__GetBool_Response__Sequence response;
} orbbec_camera_msgs__srv__GetBool_Event;

// Struct for a sequence of orbbec_camera_msgs__srv__GetBool_Event.
typedef struct orbbec_camera_msgs__srv__GetBool_Event__Sequence
{
