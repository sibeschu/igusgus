...
inline void to_yaml(
  const orbbec_camera_msgs::srv::GetString_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const orbbec_camera_msgs::srv::GetString_Request & msg)
{
...
[[deprecated("use orbbec_camera_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const orbbec_camera_msgs::srv::GetString_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  orbbec_camera_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use orbbec_camera_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const orbbec_camera_msgs::srv::GetString_Response & msg)
{
  return orbbec_camera_msgs::srv::to_yaml(msg);
}
...
[[deprecated("use orbbec_camera_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const orbbec_camera_msgs::srv::GetString_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  orbbec_camera_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use orbbec_camera_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const orbbec_camera_msgs::srv::GetString_Event & msg)
{
  return orbbec_camera_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<orbbec_camera_msgs::srv::GetString_Event>()
{
  return "orbbec_camera_msgs::srv::GetString_Event";
}

template<>
inline const char * name<orbbec_camera_msgs::srv::GetString_Event>()
{
  return "orbbec_camera_msgs/srv/GetString_Event";
}

template<>
struct has_fixed_size<orbbec_camera_msgs::srv::GetString_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<orbbec_camera_msgs::srv::GetString_Event>
  : std::integral_constant<bool, has_bounded_size<orbbec_camera_msgs::srv::GetString_Request>::value && has_bounded_size<orbbec_camera_msgs::srv::GetString_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<orbbec_camera_msgs::srv::GetString_Event>
  : std::true_type {};
