...
// IWYU pragma: private, include "orbbec_camera_msgs/srv/get_device_info.h"
...
enum
{
  orbbec_camera_msgs__srv__GetDeviceInfo_Event__request__MAX_SIZE = 1
};
// response
enum
{
  orbbec_camera_msgs__srv__GetDeviceInfo_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetDeviceInfo in the package orbbec_camera_msgs.
typedef struct orbbec_camera_msgs__srv__GetDeviceInfo_Event
{
  service_msgs__msg__ServiceEventInfo info;
  orbbec_camera_msgs__srv__GetDeviceInfo_Request__Sequence request;
  orbbec_camera_msgs__srv__GetDeviceInfo_Response__Sequence response;
} orbbec_camera_msgs__srv__GetDeviceInfo_Event;

// Struct for a sequence of orbbec_camera_msgs__srv__GetDeviceInfo_Event.
typedef struct orbbec_camera_msgs__srv__GetDeviceInfo_Event__Sequence
{
