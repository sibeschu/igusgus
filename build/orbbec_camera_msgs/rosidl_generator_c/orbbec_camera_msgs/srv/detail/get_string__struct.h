...
enum
{
  orbbec_camera_msgs__srv__GetString_Event__request__MAX_SIZE = 1
};
// response
enum
{
  orbbec_camera_msgs__srv__GetString_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetString in the package orbbec_camera_msgs.
typedef struct orbbec_camera_msgs__srv__GetString_Event
{
  service_msgs__msg__ServiceEventInfo info;
  orbbec_camera_msgs__srv__GetString_Request__Sequence request;
  orbbec_camera_msgs__srv__GetString_Response__Sequence response;
} orbbec_camera_msgs__srv__GetString_Event;

// Struct for a sequence of orbbec_camera_msgs__srv__GetString_Event.
typedef struct orbbec_camera_msgs__srv__GetString_Event__Sequence
{
