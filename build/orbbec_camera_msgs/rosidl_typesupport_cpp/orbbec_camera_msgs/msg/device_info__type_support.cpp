...
static const _DeviceInfo_type_support_symbol_names_t _DeviceInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, orbbec_camera_msgs, msg, DeviceInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, orbbec_camera_msgs, msg, DeviceInfo)),
  }
};
...
{
  return &::orbbec_camera_msgs::msg::rosidl_typesupport_cpp::DeviceInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, orbbec_camera_msgs, msg, DeviceInfo)() {
  return get_message_type_support_handle<orbbec_camera_msgs::msg::DeviceInfo>();
}
