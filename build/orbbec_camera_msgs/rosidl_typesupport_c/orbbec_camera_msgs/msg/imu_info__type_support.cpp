...
static const _IMUInfo_type_support_symbol_names_t _IMUInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, orbbec_camera_msgs, msg, IMUInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, orbbec_camera_msgs, msg, IMUInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, orbbec_camera_msgs, msg, IMUInfo)() {
  return &::orbbec_camera_msgs::msg::rosidl_typesupport_c::IMUInfo_message_type_support_handle;
}
