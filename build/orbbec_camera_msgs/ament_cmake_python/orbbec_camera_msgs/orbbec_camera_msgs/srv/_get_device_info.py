...
class GetDeviceInfo_Event(metaclass=Metaclass_GetDeviceInfo_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<orbbec_camera_msgs/GetDeviceInfo_Request, 1>',
        'response': 'sequence<orbbec_camera_msgs/GetDeviceInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['orbbec_camera_msgs', 'srv'], 'GetDeviceInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['orbbec_camera_msgs', 'srv'], 'GetDeviceInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from orbbec_camera_msgs.srv import GetDeviceInfo_Request
    ...
    def response(self, value):
        if self._check_fields:
            from orbbec_camera_msgs.srv import GetDeviceInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetDeviceInfo(metaclass=Metaclass_GetDeviceInfo):
    ...
    from orbbec_camera_msgs.srv._get_device_info import GetDeviceInfo_Event as Event
