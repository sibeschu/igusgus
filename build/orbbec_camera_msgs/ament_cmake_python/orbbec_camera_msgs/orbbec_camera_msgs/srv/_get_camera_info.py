...
class GetCameraInfo_Event(metaclass=Metaclass_GetCameraInfo_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<orbbec_camera_msgs/GetCameraInfo_Request, 1>',
        'response': 'sequence<orbbec_camera_msgs/GetCameraInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['orbbec_camera_msgs', 'srv'], 'GetCameraInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['orbbec_camera_msgs', 'srv'], 'GetCameraInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from orbbec_camera_msgs.srv import GetCameraInfo_Request
    ...
    def response(self, value):
        if self._check_fields:
            from orbbec_camera_msgs.srv import GetCameraInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetCameraInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'orbbec_camera_msgs.srv.GetCameraInfo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from orbbec_camera_msgs.srv import _get_camera_info
...
class GetCameraInfo(metaclass=Metaclass_GetCameraInfo):
    from orbbec_camera_msgs.srv._get_camera_info import GetCameraInfo_Request as Request
    from orbbec_camera_msgs.srv._get_camera_info import GetCameraInfo_Response as Response
    from orbbec_camera_msgs.srv._get_camera_info import GetCameraInfo_Event as Event
