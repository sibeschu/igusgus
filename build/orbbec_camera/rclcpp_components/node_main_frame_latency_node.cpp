...
#define NODE_MAIN_LOGGER_NAME "frame_latency_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libframe_latency.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<orbbec_camera::FrameLatencyNode>";
